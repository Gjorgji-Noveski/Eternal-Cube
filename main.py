...
def reinitializeVariables():
    global platforms, goingUP, goingDOWN, closestPlatforms, platformSpeed, gameActive
    platforms.clear()
    goingUP = False
    goingDOWN = False
    closestPlatforms = None
...
while True:
    ...
    if gameActive:
        ...
        if goingUP and closestPlatforms:
            movePlatform(closestPlatforms, direction='UP')
        if goingDOWN and closestPlatforms:
            movePlatform(closestPlatforms, direction='DOWN')
